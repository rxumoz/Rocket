...
public class FileChooseAction {
    ...
    public static final int REQUEST_CODE_READ_STORAGE_PERMISSION = 100;
    ...
    public void performAction() {
        ...
        final int permission = ContextCompat.checkSelfPermission(hostFragment.getContext(),
                Manifest.permission.READ_EXTERNAL_STORAGE);
        if (PackageManager.PERMISSION_GRANTED == permission) {
            startChooserActivity();
        } else {
            hostFragment.requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
